...
$title = 'R&Day';
$title_page = 'Cookies';
$description_page = "Page de cookies";
?>
...
<section class="template-section avant-block">
    <div class="template-container">
        ...
        <br>
        <p class="text">Bienvenue sur votre site de la Journée de Recherche et Développement (R&Day) 2024. 
        ...
        <p class="text">Un cookie est un petit fichier texte stocké sur votre ordinateur ou appareil mobile 
        ...
        <p class="text">Lorsque vous visitez notre site, nous sollicitons votre consentement pour utiliser 
        ...
        <p class="text">Ces cookies sont nécessaires au bon fonctionnement de notre site Web. Ils incluent des 
        ...
        <p class="text">Nous utilisons des cookies de performance pour recueillir des informations anonymes sur 
        ...
        <p class="text">Nous pouvons utiliser des cookies de ciblage et de publicité pour personnaliser le 
        ...
        <p class="text">La durée de conservation des cookies varie en fonction de leur type. Les cookies de session 
        ...
        <p class="text">Vous pouvez gérer vos préférences de cookies en ajustant les paramètres de votre navigateur. 
